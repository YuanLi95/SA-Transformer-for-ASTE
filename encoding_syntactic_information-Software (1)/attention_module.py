...
class SelfAttention(torch.nn.Module):
    def __init__(self, args):
        ...
        self.linear_k = torch.nn.Linear(args.lstm_dim * 2, args.lstm_dim  * 2)
    ...
    def forward(self, query, value, mask):
        ...
        attention_states_V = self.linear_k(value)
        # attention_states = query
        # attention_states_T = value
        attention_states_T = attention_states_V.permute([0, 2, 1])
        ...
        merged=torch.bmm(attention, attention_states_V)
        # print(merged.shape)
        # exit()
...
class Syntactic_Attention(torch.nn.Module):
    def __init__(self, args):
        super(Syntactic_Attention,self).__init__()
        self.args = args
        self.linear_q = torch.nn.Linear(args.lstm_dim * 2, args.lstm_dim * 2)
