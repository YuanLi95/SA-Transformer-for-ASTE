                    ...
                    for i in range(al, ar+1):
                        for j in range(pl, pr+1):
                            if args.task == 'pair':
                                ...
                                self.tags[i][j] = sentiment2id[pair['sentiment']]
...
class DataIterator(object):
    ...
    def get_batch(self, index):
        ...
        for i in range(index * self.args.batch_size,
            ...
            # # print(self.instances[i].id)
            # if self.instances[i].id == "1424":
            #     print(self.instances[i].sentence_tokens)
